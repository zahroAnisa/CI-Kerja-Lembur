...
<head>
    ...
    <title>View User | KLTime - Admin KLTime Jayapura</title>
    ...
    <!--[if lt IE 8]>
        ...
        <![endif]-->
                                    ...
                                    <?php include 'menu/header.php'; ?>
                                            ...
                                            <!-- START MENU MOBILE -->
                                    <?php include 'menu/menu_android.php'; ?>
                                            <!-- END MENU MOBILE -->

                                            <!-- START MENU WEB-->
                                            <!-- TAB MENU START-->
                                    <?php include 'menu/menu_tab_task.php'; ?>     
                                            <!-- END MENU WEB-->
                                            <!-- TAB MENU END-->

                                            <!-- START INDEX HOME -->
                                    <?php include 'view/view_data_user.php'; ?> 
                                            <!-- END INDEX HOME -->                                                
                                            <!-- START FOOTER -->
