        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    ...
                    <!-- START TAB TASK -->
                    <li class="active"><a data-toggle="tab" href="#Task"><i class="notika-icon notika-form"></i> Tasks</a>
                    </li>
                    <!-- END TAB TASK -->
                ...
                <div class="tab-content custom-menu-content">
                    ...
                    <!-- START TAB MENU TASK -->
                    <div id="Task" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
